        ...
        <ol>
          ...
          <li>
            ...
            <p>
              ...
              <a href="https://whatsnext-v2.vercel.app">whatsnext</a>, you are
          ...
          <li>
            ...
            <p>
              ...
              materials on whatsnext&apos;s Website for personal, non-commercial
            ...
            <p>
              This will let whatsnext to terminate upon violations of any of
          ...
          <li>
            <p>Disclaimer</p>
            <p>
              All the materials on whatsnext&apos;s Website are provided “as
              is”. whatsnext makes no warranties, may it be expressed or
              implied, therefore negates all other warranties. Furthermore,
              whatsnext does not make any representations concerning the
          ...
          <li>
            <p>Limitations</p>
            <p>
              whatsnext or its suppliers will not be hold accountable for any
              damages that will arise with the use or inability to use the
              materials on whatsnext&apos;s Website, even if whatsnext or an
          ...
          <li>
            ...
            <p>
              The materials appearing on whatsnext&apos;s Website may include
              technical, typographical, or photographic errors. whatsnext will
              not promise that any of the materials in this Website are
              accurate, complete, or current. whatsnext may change the materials
              contained on its Website at any time without notice. whatsnext
          ...
          <li>
            <p>Links</p>
            <p>
              whatsnext has not reviewed all of the sites linked to its Website
              and is not responsible for the contents of any such linked site.
              The presence of any link does not imply endorsement by whatsnext
              of the site. The use of any linked website is at the user&apos;s
              own risk.
            </p>
          </li>
          {/* Links */}
