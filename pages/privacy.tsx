  ...
  return (
    <div>
      ...
      >
        ...
        <div>
          <p>
            This privacy notice for whatsnext{" "}
          ...
          <ul className=" list-disc">
            <li>
              ...
              <a
                href="https://whatsnext-v2.vercel.app"
                className="dark:text-white"
              >
                https://whatsnext-v2.vercel.app
              </a>
          ...
          <p>
            ...
            <a href="mailto:whatsnext@support.com">whatsnext@support.com</a>.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            depending on how you interact with whatsnext and the Services, the
            choices you make, and the products and features you use. Click here
            to learn more
          </p>
          <p>
          ...
          <p>
            ...
            available here, or by contacting us. We will consider and act upon
